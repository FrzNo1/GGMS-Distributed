...
, int numPivots, int sizeOfSample, int totalSmallBuckets, uint min, uint max) {
  ...
  */
  ...
  template int bucketMultiselectWrapper 
  		(int * d_vector, int length, uint * kVals_ori, int numKs
         , int * outputs, int blocks, int threads);
  template unsigned int bucketMultiselectWrapper 
  		(unsigned int * d_vector, int length, uint * kVals_ori, int numKs
         , unsigned int * outputs, int blocks, int threads);
  template float bucketMultiselectWrapper 
  		(float * d_vector, int length, uint * kVals_ori, int numKs
         , float * outputs, int blocks, int threads);
  template double bucketMultiselectWrapper 
  		(double * d_vector, int length, uint * kVals_ori, int numKs
